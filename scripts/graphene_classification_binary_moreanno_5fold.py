...
def main():
    ...
    feature_path = '../results/data_111x_individual_script/graphene_classifier_with_moreanno_colorfea-%s'%(args.color_fea)
    result_classify_path = '../results/data_111x_individual_script/graphene_classifier_with_moreanno_colorfea-%s_5fold_multiclass-%d'%(args.color_fea, args.multi_class)
    ...
    for method in methods:
        for C in Cs:
            ...
            for ni in range(n_cross):
                ...
                # val_graphene_names = [all_img_names[graphene_idxs[ij]] for ij in val_group_graphene_idxes[ni]]
