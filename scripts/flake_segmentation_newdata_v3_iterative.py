...
hyperparams = { 'im_thre_high': 4, # given the residulal map, about this threshould is identified as foreground.
                'im_thre_low': 4, # given the residulal map, about this threshould is identified as foreground.
...
def process_one_image(img_name, save_name, fig_save_name, im_i):
    ...
    res_map, image_labelmap, flake_centroids, flake_sizes, num_flakes = utils.perform_robustfit_multichannel_v3(im_hsv, im_gray, hyperparams['im_thre_high'], hyperparams['im_thre_low'], hyperparams['size_thre'])
