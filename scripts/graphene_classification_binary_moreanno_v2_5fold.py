...
def main():
    ...
    feature_path = '../results/data_111x_individual_script/graphene_classifier_with_moreanno_v2_colorfea-%s'%(args.color_fea)
    result_classify_path = '../results/data_111x_individual_script/graphene_classifier_with_moreanno_v2_colorfea-%s_5fold_multiclass-%d'%(args.color_fea, args.multi_class)
        ...
        for C in Cs:
            ...
            for ni in range(n_cross):
                ...
                for imx in range(val_feats.shape[0]):
                    ori_name = os.path.join('../results/data_111x_individual_script/flake_vis_moreanno_v2', val_names[imx])
                    if args.multi_class == 1:
