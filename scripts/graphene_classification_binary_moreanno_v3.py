...
def main():
    ...
    result_classify_path = '../results/data_111x_individual_script/graphene_classifier_with_moreanno_v3_colorfea-%s'%(args.color_fea)
    flake_vis_path = '../results/data_111x_individual_script/flake_vis_moreanno_v3'
