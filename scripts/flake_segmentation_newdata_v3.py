...
hyperparams = { #'im_thre': 1.5, # given the residulal map, about this threshould is identified as foreground.
                # 'size_thre': 100, # after detect foreground regions, filter them based on its size. (0 means all of them are kept).
                'im_thre': 3, # given the residulal map, about this threshould is identified as foreground.
...
def main():
    ...
    result_path = '../results/data_mar2020_script/mat_%.1f_%d'%(hyperparams['im_thre'], hyperparams['size_thre'])
    result_fig_path = '../results/data_mar2020_script/fig_%.1f_%d'%(hyperparams['im_thre'], hyperparams['size_thre'])
...
def debug():
    ...
    # save_name = '../results/data_mar2020_script/mat/EXP/G03132020UK50X_2/G_tile__ix000_iy000_debug'
    # fig_save_name = '../results/data_mar2020_script/fig/EXP/G03132020UK50X_2/G_tile__ix000_iy000_debug'
    
    # img_name = '../data/data_mar2020/EXP/G03132020UK50X_2/G_tile__ix000_iy000.tif'
    img_name = '../data/data_mar2020/EXP/G03132020UK50X/G_tile__ix000_iy000.tif'
    save_name = '../results/data_mar2020_script/mat/' + img_name.split('/', 3)[-1] +  '_debug_%.2f'%(hyperparams['im_thre'])
    fig_save_name = '../results/data_mar2020_script/fig/' + img_name.split('/', 3)[-1] +  '_debug_%.2f'%(hyperparams['im_thre'])
    ...
    # if not os.path.exists(save_dir):
    #     os.makedirs(save_dir)
    # save_name = '../results/data_111x_individual_script/mat/' + img_name.split('/', 3)[-1] +  '_debug_%.2f'%(hyperparams['im_thre'])
    # fig_save_name = '../results/data_111x_individual_script/fig/' + img_name.split('/', 3)[-1] +  '_debug_%.2f'%(hyperparams['im_thre'])
