        ...
        for i in range(len(tmp_flake)):
            if tmp_flake[i]['flake_size'] > size_thre:
                ...
                if 'subsegment' in color_fea:
                    ...
                    img_fea = np.concatenate([img_fea, tmp_flake[i]['subsegment_features_3_loc_0']])
...
def main():
    ...
    result_classify_path = '../results/data_111x_individual_script/graphene_classifier_with_moreanno_colorfea-%s'%(args.color_fea)
    annotation_path = '../data/anno_graphene_v2_youngjae'
