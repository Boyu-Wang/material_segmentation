...
#     result_path = '../results/data_sep2019_script/mat'
    ...
    data_path = '../data/data_1015'
    result_path = '../results/data_1015_script/mat'
    
    # result_classify_path = '../results/data_sep2019_script/classify'
    # result_classify_path = '../results/data_sep2019_script/classify_graphene_new'
    result_classify_path = '../results/data_1015_script/classify_graphene_new'
    ...
    classifier = pickle.load(open('../results/data_sep2019_script/EXP1/09192019 Graphene/graphenethickthinglue_clf_complete_v2/feanorm_weighted_classifier-linearsvm-0.100000.p','rb'))
