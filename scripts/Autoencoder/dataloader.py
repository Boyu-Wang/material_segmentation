...
class LabelDataLoader(DD.Dataset):
    def __init__(self, img_dir_prefix, mask_dir_prefix, input_type, input_with_mask, subset='train', transform=None, img_size=256):
...
class AllDataLoader(DD.Dataset):
    def __init__(self, data_type, img_dir_prefix, mask_dir_prefix, input_type, input_with_mask, transform=None, img_size=256):
