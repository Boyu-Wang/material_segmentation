...
%     Intersection(ho_RegionI, ho_RegionS, &ho_RegionIII);
    ...
    nR = 2; nC = 3;
    figure(im_id); subplot(nR, nC, 1); imshow(im);
...
%     print(im_id, '-dpdf', fullfile(saveDir, [img_names(im_id).name(1:end-4), '_entropythre.pdf']));
end